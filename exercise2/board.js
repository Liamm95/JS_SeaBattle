...
const field = prompt("Укажите размер поля:");
const board = new Board(field);
const ShipTest = new Ship("ShipTest", 3, 0);

board.placeShip(ShipTest, 0, 0);
console.log(`${board.getSize}, ${board.receiveAttack(1, 0)}`);
board.display();
